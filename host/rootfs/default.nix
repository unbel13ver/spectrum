...
, busybox, cloud-hypervisor, cryptsetup, execline, jq, kmod, dbus, xdg-utils, glxinfo
, mdevd, s6, s6-linux-init, socat, util-linuxMinimal, xorg, strace, wayland-utils, cacert
}:
...
let
  ...
  packages = [
    ...
    socat start-vm strace dbus xdg-utils wayland-utils glxinfo cacert
