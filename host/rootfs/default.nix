...
, busybox, cloud-hypervisor, cryptsetup, execline, jq, kmod, dbus, cacert
, mdevd, s6, s6-linux-init, socat, util-linuxMinimal, xorg, strace, e2fsprogs
}:
...
let
  ...
  packages = [
    ...
    socat start-vm strace dbus cacert
